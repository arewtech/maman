    ...
    <div class="">
      ...
      <div class="flex flex-wrap gap-y-10 text-center md:justify-between md:text-left">
        <div class="basis-full md:basis-1/3">
          <span class="mb-5 block text-base font-semibold text-gray-500 lg:mb-8">2017 - 2018</span>
          <h3 class="font-semibold">High School Diploma</h3>
          <p class="mb-3 text-sm text-gray-500">MA Arriyadlah High School</p>
          <!-- <p class="mb-3 text-sm text-gray-500">RMIT University,</p> -->
          <h3 class="font-semibold">Vocational Programs</h3>
          <p class="text-sm text-gray-500">PLTU, Batang</p>
        </div>
        <div class="basis-full md:basis-1/3">
        ...
        <div class="basis-full md:basis-1/3">
          <span class="mb-5 block text-base font-semibold text-gray-500 lg:mb-8"
            >2022 - PRESENT</span
          >
          <h3 class="font-semibold">Web Designer</h3>
          <p class="mb-3 text-sm text-gray-500">Freelance, WFA</p>
          <h3 class="font-semibold">Frontend Web Developer</h3>
          <p class="mb-3 text-sm text-gray-500">Oxxo Creative Digital, Jakarta</p>
